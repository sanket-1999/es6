...
/***/ function(module, exports, __webpack_require__) {
	...
	var _const = __webpack_require__(332);

	var _scoping = __webpack_require__(333);

	var _order = __webpack_require__(334);

	var _array = __webpack_require__(335);

	var _add = __webpack_require__(336);

	var _userfriends = __webpack_require__(337);

	var _printCapitalNames = __webpack_require__(338);

	var _tempelateliteral = __webpack_require__(339);

	var _destruct = __webpack_require__(340);

	var _deepmatch = __webpack_require__(341);

	var _bank = __webpack_require__(342);

	var _arm = __webpack_require__(343);
	...
	// import { fibonacci } from './components/fibonaci.js';
	(0, _promise.promise)();
	/// import { armm  } from './components/armm.js';
	...
	var Array = exports.Array = {
	    ...
	    printResults: function printResults() {
	        ...
	        this.names.map(function (name) {
	            return document.write("{name:", name, " , length: ", name.length, "}", "<br>");
	        });
	    }
	};
...
/***/ function(module, exports) {
	...
	// document.write("with parameter  values :",add(5, 2),"<br>");
	// document.write("with default values :",add());
...
/***/ function(module, exports) {
	...
	exports.printCapitalNames = printCapitalNames;
	...
	var name = ['val', 'value', 'random ', 'ran', 'user'];
...
/***/ function(module, exports) {
	...
	function template() {
	                ...
	                var message = 'My name is ' + name + ' and i am having issues with my pc bearning model no ' + model + ' \n                i have been assign ' + deskno + ' please fix it ASAP ';
...
/***/ function(module, exports) {
	...
	var Account = function Account(name, id, balance) {
	...
	var SavingsAccount = exports.SavingsAccount = function (_Account) {
	    _inherits(SavingsAccount, _Account);

	    function SavingsAccount(name, id, balance, interest) {
	        _classCallCheck(this, SavingsAccount);

	        var _this = _possibleConstructorReturn(this, (SavingsAccount.__proto__ || Object.getPrototypeOf(SavingsAccount)).call(this, name, id, balance));
	...
	var CurrentAccount = exports.CurrentAccount = function (_Account2) {
	    _inherits(CurrentAccount, _Account2);

	    function CurrentAccount(name, id, balance, cashcredit) {
	        _classCallCheck(this, CurrentAccount);

	        var _this2 = _possibleConstructorReturn(this, (CurrentAccount.__proto__ || Object.getPrototypeOf(CurrentAccount)).call(this, name, id, balance));
	...
	function total() {
	    ...
	    var savingsAccount = new SavingsAccount("sanket", 100, 100, 10);
	    document.write("saving account balance and interest is :" + savingsAccount.balance + " " + savingsAccount.interest + "<br>");

	    var currentAccount = new CurrentAccount("sanket", 101, 101, 101);

	    document.write("current account balance and credit is :" + currentAccount.balance + " " + currentAccount.cashcredit + " <br>");

	    var total = savingsAccount.balance + savingsAccount.balance * savingsAccount.interest / 100 + currentAccount.balance + currentAccount.cashcredit;
